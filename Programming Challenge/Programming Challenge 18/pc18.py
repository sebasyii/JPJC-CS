...
class Hashtable:
    ...
    def DisplayValues(self):
        print("{0:^10} | {1:^25} | {2:^20}".format("Index","Person Name","Telephone Number"))
        for element in range(self.__size):
            
            if (self.__records[element].getPersonName() != '' and self.__records[element].getPersonName() != ''):
                print("{0:^10} | {1:^25} | {2:<20}".format(element, str(self.__records[element].getPersonName()),
