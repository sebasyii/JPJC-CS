def CreateUpdateFile():
    ...
    if int(modified_data[1]) > int(modified_data[3]):
        new_file.write('{0},{1},{2},{3}\n'.format(modified_data[0], 'W', modified_data[1], modified_data[3]))
        new_file.write('{0},{1},{2},{3}\n'.format(modified_data[2], 'L',modified_data[3], modified_data[1]))
    elif int(modified_data[3]) > int(modified_data[1]):
        new_file.write('{0},{1},{2},{3}\n'.format(modified_data[0], 'L', modified_data[1], modified_data[3]))
        new_file.write('{0},{1},{2},{3}\n'.format(modified_data[2], 'W', modified_data[3], modified_data[1]))
    results.close()
    new_file.close()
##CreateUpdateFile()
...
def newCreateUpdateFileTask2():
    ...
    for data in results:
        ...
        if int(modified_data[1]) > int(modified_data[3]):
            ...
            new_file.write('{0},{1},{2},{3}\n'.format(modified_data[0], 'D', modified_data[1], modified_data[3]))
            new_file.write('{0},{1},{2},{3}\n'.format(modified_data[2], 'D', modified_data[3], modified_data[1]))
...
def ComputeTeamStat(team_name):
    ...
    print('{0:<10} {1:<3} {2:<3} {3:<3} {4:<3} {5:<3} {6:<3} {7:<3} {8:<3}'.format(team_name, games_played, games_won, games_drawn,
                                                           games_lost, goals_for, goals_lost, goal_diff,
                                                           points))
    return [team_name,points, goal_diff]
print('{0:<10} {1:<3} {2:<3} {3:<3} {4:<3} {5:<3} {6:<3} {7:<3} {8:<3}'.format('Team','P','W','D','L','GF','GA','GD','Points'))
